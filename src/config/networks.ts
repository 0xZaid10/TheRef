...
export const NETWORKS: Record<NetworkId, NetworkConfig> = {
  studionet: {
    ...
    name:        "Studionet",
    label:       "Studionet",
    description: "Development network with full read/write support",
    ...
    speed:       "Fast",
    addresses: {
      CORE: process.env.NEXT_PUBLIC_STUDIONET_CORE ?? "0x88CAA18419714aA38CdF53c0E603141c48fa3238",
  ...
  bradbury: {
    ...
    description: "Public testnet with real multi-model AI consensus",
    ...
    addresses: {
      CORE: process.env.NEXT_PUBLIC_BRADBURY_CORE ?? "0xA29CfFC83d32fe924cFf1F1bDCf21555CCC96206",
...
export const CONTRACT_DESCRIPTIONS: Record<keyof NetworkAddresses, string> = {
  CORE: "Hub contract - games, moves, AI judgment, leaderboard wiring",
