...
export const NETWORKS: Record<NetworkId, NetworkConfig> = {
  studionet: {
    ...
    speed:       "Fast",
    addresses: {
      CORE:    process.env.NEXT_PUBLIC_STUDIONET_CORE    ?? "0x58B9f8b7D7B448C6D56C22A90556c632CB2F78FA",
  ...
  bradbury: {
    ...
    addresses: {
      CORE:    process.env.NEXT_PUBLIC_BRADBURY_CORE    ?? "0x05add101F032307cB05fd58Ba1EC37F545280A55",
